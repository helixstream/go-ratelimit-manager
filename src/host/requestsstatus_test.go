		...
		testCases := []HostStatusTest{
			{
				...
				hosts[0],
				1,
				newRequestsStatus(500, 500, 0, now-(hosts[0].sustainedTimePeriod*1000)-50, now-(hosts[0].burstTimePeriod*1000)-100, 0),
				newRequestsStatus(0, 0, 1, now, now, 0),
				true,
			},
			{
				"not is sustained, not in burst, no sus limit, no burst limit",
				hosts[1],
				5,
				newRequestsStatus(500, 500, 0, now-(hosts[1].sustainedTimePeriod*1000)-500, now-(hosts[0].burstTimePeriod*1000)-100, 0),
				newRequestsStatus(0, 0, 5, now, now, 0),
				true,
			},
			{
				...
				hosts[0],
				1,
				newRequestsStatus(500, 500, 20, now, now-(hosts[0].burstTimePeriod*1000)-100, 0),
				newRequestsStatus(500, 0, 21, now, now, 0),
				true,
			},
			{
				"is in sustained, not in burst, no sustained limit, burst limit does not matter",
				hosts[1],
				3,
				newRequestsStatus(500, 10, 20, now-30000, now-(hosts[0].burstTimePeriod*1000), 0),
				newRequestsStatus(500, 0, 23, now-30000, now, 0),
				true,
			},
			{
				...
				hosts[0],
				1,
				newRequestsStatus(1195, 5, 5, now-((hosts[0].sustainedTimePeriod*1000)/2), now-(hosts[0].burstTimePeriod*1000)-100, 0),
				newRequestsStatus(1195, 0, 5, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				false,
			},
			{
				"is in sustained, not in burst, will hit sustained limit, burst limit does not matter",
				hosts[1],
				5,
				newRequestsStatus(597, 5, 5, now-(hosts[1].sustainedTimePeriod*1000)+100, now-(hosts[0].burstTimePeriod*1000)-100, 0),
				newRequestsStatus(597, 0, 5, now-(hosts[0].sustainedTimePeriod*1000)+100, now, 0),
				false,
			},
			{
				...
				hosts[0],
				1,
				newRequestsStatus(1000, 18, 2, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				newRequestsStatus(1000, 18, 2, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				false,
			},
			{
				...
				hosts[1],
				5,
				newRequestsStatus(1000, 15, 1, now-((hosts[1].sustainedTimePeriod*1000)/2), now, 0),
				newRequestsStatus(1000, 15, 1, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				false,
			},
			{
				...
				hosts[0],
				1,
				newRequestsStatus(1195, 8, 6, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				newRequestsStatus(1195, 8, 6, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				false,
			},
			{
				...
				hosts[1],
				1,
				newRequestsStatus(1195, 8, 6, now-((hosts[1].sustainedTimePeriod*1000)/2), now, 0),
				newRequestsStatus(1195, 8, 6, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				false,
			},
			{
				...
				hosts[0],
				1,
				newRequestsStatus(1000, 10, 4, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				newRequestsStatus(1000, 10, 5, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				true,
			},
			{
				"is in sustained, is in burst, will not hit either limit",
				hosts[1],
				3,
				newRequestsStatus(400, 10, 4, now-((hosts[0].sustainedTimePeriod*1000)/2), now, 0),
				newRequestsStatus(400, 10, 7, now-((hosts[1].sustainedTimePeriod*1000)/2), now, 0),
				true,
			},
		}
